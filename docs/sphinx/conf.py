...
try:
    from actortest import __version__
except ModuleNotFoundError:
    from sdsstools import get_package_version
    __version__ = get_package_version(__file__, 'sdss-actortest') or 'dev'
...
project = 'actortest'
copyright = '{0}, {1}'.format('2022', 'Gyoik Kim')
author = 'Gyoik Kim'
...
.. |actortest_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('actortest')
...
man_pages = [
    (master_doc, 'actortest', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/actortest'
